function MATSEDLAB_ox
tic;                        %start timing

global sol sol1 SimValues u_ave NumVars;
global n_segment;
...
sol1 = pdepe(0,@pdex14pde,@pdex1ic,@pdex1bc,x,t);    %Extract each species concentration at each time and depth
toc;                                                %stop timing

for j=1:NumVars
    SimValues{j,n_segment} = sol1(:,:,j);
end
