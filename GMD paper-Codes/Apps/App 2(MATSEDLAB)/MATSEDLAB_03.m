function MATSEDLAB_03(VarNames, DataValuesX1, SimValues, ...
...
%   Detailed explanation goes here
    ...
    for i=1:NumVars,
        ...
        if (size(fieldValues , 2) >= 2)
            scatter(fieldValues(:, 2), fieldValues(:, 1) );%displays colored circles at the locations specified by the vectors X and Y (which must be the same size).
